    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="title m-0">{{ __('Edit Product Info') }}</h5>
            </div>
            <div class="card-body">
            <form action="{{ route('product.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <textarea name="product_description" id="product_description" class="form-control my-2" style="height: 100px; resize: none;" placeholder="Description">{{ $product->product_description }}</textarea>
